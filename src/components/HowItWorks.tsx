import { MousePointerClick, UserCheck, Eye, Download, CheckCircle2 } from "lucide-react";

const steps = [
  {
    icon: MousePointerClick,
    title: "Acesse o Site",
    description: "Entre na plataforma e explore as opções disponíveis"
  },
  {
    icon: UserCheck,
  ...
  },
  {
    icon: CheckCircle2,
    title: "Comece a Usar",
    description: "Receba o arquivo Excel/Google Sheets e organize suas finanças"
  }
];
